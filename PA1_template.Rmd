...
```
* The imputed data mean is `r format(rmean.i, big.mark=",",decimal.mark = '.', scientific=FALSE, nsmall = 1)`
* The imputed data median is `r format(rmedian.i, big.mark=",",decimal.mark = '.', scientific=FALSE, nsmall = 1)`
* The difference between the non-imputed mean and imputed mean is `r format(mean_diff, big.mark=",",decimal.mark = '.', scientific=FALSE, nsmall = 1)`
* The difference between the non-imputed mean and imputed mean is `r format(med_diff, big.mark=",",decimal.mark = '.', scientific=FALSE, nsmall = 1)`
* The difference between total number of steps between imputed and non-imputed data is `r sprintf("%3.1f",total_diff)`. Thus, there were `r format(total_diff, big.mark=",",decimal.mark = '.', scientific=FALSE, nsmall = 1)` more steps in the imputed data.
